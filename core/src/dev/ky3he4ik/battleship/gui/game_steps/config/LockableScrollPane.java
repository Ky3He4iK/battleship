 ...
 * @author Nathan Sweet
 * <p>
 * modified by Ky3He4iK
 **/
public class LockableScrollPane extends WidgetGroup {
    /*******************************************************************************
     ...
     */
    public LockableScrollPane(Actor widget) {
     ...
     * @param widget May be null.
     */
    public LockableScrollPane(Actor widget, Skin skin) {
     ...
     * @param widget May be null.
     */
    public LockableScrollPane(Actor widget, Skin skin, String styleName) {
     ...
     * @param widget May be null.
     */
    public LockableScrollPane(@Nullable Actor widget, @NotNull ScrollPane.ScrollPaneStyle style) {
        this.style = style;
        setActor(widget);
        setSize(150, 150);
        ...
        addCaptureListener(new InputListener() {
            ...
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
                ...
                if (getStage() != null) getStage().setScrollFocus(LockableScrollPane.this);
                ...
                if (scrollBarTouch && scrollX && hScrollBounds.contains(x, y)) {
                    ...
                    if (hKnobBounds.contains(x, y) && !lockX) {
                        lastPoint.set(x, y);
                ...
                if (scrollBarTouch && scrollY && vScrollBounds.contains(x, y)) {
                    event.stop();
                    setScrollbarsVisible(true);
                    if (vKnobBounds.contains(x, y) && !lockY) {
                        lastPoint.set(x, y);
    ...
    public void setStyle(com.badlogic.gdx.scenes.scene2d.ui.ScrollPane.ScrollPaneStyle style) {
     ...
     * {@link #setStyle(com.badlogic.gdx.scenes.scene2d.ui.ScrollPane.ScrollPaneStyle)} is called.
     */
    ...
    /**
     * The style for a scroll pane, see {@link com.badlogic.gdx.scenes.scene2d.ui.ScrollPane}.
     *
     * @author mzechner
     * @author Nathan Sweet
     */
    static public class ScrollPaneStyle {
        ...
        public ScrollPaneStyle(com.badlogic.gdx.scenes.scene2d.ui.ScrollPane.ScrollPaneStyle style) {
